...
void dispatchThresholdsAndOverloads(size_t N, uint64_t k, std::initializer_list<uint64_t> threshold_sizes,
...
void thresholdBasedBumpingConsensusContenderRunner(size_t N, size_t k) {
    ...
    dispatchThresholdsAndOverloads(N, k, {x,x+1,x+2}, {1.05,1.10,1.20,1.30,1.40,1.50,1.60,1.80,2.00,2.20});
}
